...
c
      ...
      open(1234,file='nn.out', status='unknown')
...
caps
      ...
      write(500,*) c0
cc
cccccccc     INITIALIZATION  cccccccccccccccccccccccc
cc
      do ii=1,3
      do jj=1,3
...
cth
      ...
      enddo
cx
cccccccc    ELASTIC INITIAL GUESS FOR THE STRESS cccccccccc
cx

cccc cg is not constant ccccccccccccc
      jph=jphase(i,j,k)
...
cccccccccccccccccccccccccccccc start iteration ccccccccccccccccccccccc
      ...
      write(*,*) 'in  loop'
cccccccccccccccccccccccccccccccccc write cccccccccccccccccccccccc
       write(*,*) 'writing...'
...
cCCCCCCCCCCCCCCCCCCCCCC ALTERNATE CCCCCCCCCCCCCCCCCCCCCCCCCCC
...
ccccccccccccccccccccc here read back the matlab approximation into
convout cccccccccccccccccccc
...
ccccccccccc   computes avg ccccccccccccccccccccc      
